		...
		if(isset($product_plan_purchase_arr->purchase->planName)) {?>
			...
			<table height="100%" width="100%">
				...
				<tr>
					...
					<?php printf('<td><img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=%s&choe=UTF-8" alt="QR Code" title="QR Code" style="display:block" width="300" height="300"><br /><span class="dashicons dashicons-phone"></span> %s</td>',$product_plan_purchase_arr->purchase->esim->qrCodeString,$product_plan_purchase_arr->purchase->esim->phone);?>
				</tr>
			</table>
			<?php
		}
